        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="pt-12 space-y-4">
              ...
              <img src="https://images.unsplash.com/photo-1476224203421-9ac39bcb3327?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTl8fHJlc3RhdXJhbnQlMjBmb29kfGVufDB8fDB8fHww" className="w-full h-1/2 object-cover rounded-sm" referrerPolicy="no-referrer" />
            </div>
          </motion.div>
        </div>
      </div>
